...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, BP_AT,          BP_TILD,        RALT(BP_COMM),  BP_APOS,        BP_LGIL,                                        BP_RGIL,        BP_GRV,         BP_DQOT,        BP_DTRM,        TD(DANCE_23),   KC_TRANSPARENT, 
    KC_CAPS,        BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_16),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_24),   BP_MDSH,        BP_RCBR,        BP_UGRV,        OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, BP_DCRC,        RALT(BP_2),                                     RALT(BP_3),     BP_DLR,         ST_MACRO_0,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_17),                                   KC_TRANSPARENT, KC_ESCAPE
  ),
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, ST_MACRO_3,     KC_Y,           KC_X,           TD(DANCE_26),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           ST_MACRO_4,     KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRC),                                  RALT(KC_RBRC),  ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_42),   KC_TRANSPARENT, 
    KC_CAPS,        KC_QUES,        KC_LCBR,        RALT(LSFT(KC_S)),TD(DANCE_35),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_43),   ST_MACRO_10,    KC_RCBR,        ST_MACRO_11,    OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        ST_MACRO_7,                                     ST_MACRO_12,    KC_DLR,         RALT(KC_M),     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_36),                                   KC_TRANSPARENT, KC_ESCAPE
  ),
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_45),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           FR_CCED,        KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        ST_MACRO_13,                                    ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        FR_UMLT,        TD(DANCE_61),   KC_TRANSPARENT, 
    KC_CAPS,        FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_54),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_62),   ST_MACRO_17,    FR_RCBR,        FR_UGRV,        OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, FR_CCIRC,       ST_MACRO_14,                                    ST_MACRO_18,    FR_DLR,         FR_MU,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_55),                                   KC_TRANSPARENT, KC_ESCAPE
  ),
  [9] = LAYOUT_voyager(
    TD(DANCE_63),   TD(DANCE_64),   TD(DANCE_65),   TD(DANCE_66),   TD(DANCE_67),   TD(DANCE_68),                                   TD(DANCE_69),   TD(DANCE_70),   TD(DANCE_71),   TD(DANCE_72),   TD(DANCE_73),   KC_MS_UP,       
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,                                        KC_KP_3,        KC_KP_1,        KC_KP_9,        KC_KP_5,        KC_KP_7,        KC_MS_DOWN,     
    KC_LEFT_SHIFT,  KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_KP_DOT,      KC_MS_WH_UP,                                    KC_MS_WH_DOWN,  TD(DANCE_74),   TD(DANCE_75),   TD(DANCE_76),   KC_KP_COMMA,    KC_NUM,         
    KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_RIGHT, RGB_TOG,        TOGGLE_LAYER_COLOR,KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_77),   TD(DANCE_78),   KC_MS_LEFT,     KC_MS_RIGHT,    KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_64] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_64_finished, dance_64_reset),
        [DANCE_65] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_65_finished, dance_65_reset),
        [DANCE_66] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_66_finished, dance_66_reset),
