...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_ESCAPE,      BP_B,           BP_ECUT,        BP_P,           BP_O,           BP_EGRV,                                        BP_Q,           BP_D,           BP_L,           BP_J,           BP_Z,           KC_UP,          
    KC_TAB,         BP_A,           BP_U,           BP_I,           BP_E,           TD(DANCE_0),                                    BP_T,           BP_S,           BP_R,           BP_N,           BP_M,           KC_DOWN,        
    OSM(MOD_LSFT),  BP_AGRV,        BP_Y,           BP_X,           TD(DANCE_1),    BP_K,                                           BP_CCED,        BP_G,           BP_H,           BP_F,           BP_W,           OSM(MOD_RSFT),  
    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    TT(2),          BP_C,           KC_BSPC,                                        TD(DANCE_6),    BP_V,           TT(1),          KC_LEFT,        KC_RIGHT,       OSM(MOD_RGUI),  
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, BP_UNDS,        BP_LBRC,        BP_LPRN,        BP_EQL,         TD(DANCE_8),                                    TD(DANCE_9),    BP_PERC,        BP_RPRN,        BP_RBRC,        BP_EXLM,        CW_TOGG,        
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_CAPS,        BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_15),   RALT(BP_2),                                     RALT(BP_3),     TD(DANCE_22),   BP_MDSH,        BP_RCBR,        BP_UGRV,        OSM(MOD_RSFT),  
  ...
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_B,           ST_MACRO_1,     KC_P,           BP_O,           ST_MACRO_2,                                     KC_Q,           KC_D,           KC_L,           KC_J,           KC_Z,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_23),                                   KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_3,     KC_Y,           KC_X,           TD(DANCE_24),   KC_K,                                           ST_MACRO_4,     KC_G,           KC_H,           KC_F,           KC_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(5),          KC_C,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_V,           TT(4),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_voyager(
    TO(9),          KC_PIPE,        KC_AMPR,        KC_MINUS,       KC_ASTR,        KC_LABK,                                        KC_RABK,        KC_SLASH,       KC_PLUS,        KC_HASH,        KC_BSLS,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_6,           KC_4,           KC_8,           KC_0,           KC_2,                                           KC_3,           KC_1,           KC_9,           KC_5,           KC_7,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_UNDS,        KC_LBRC,        KC_LPRN,        KC_EQUAL,       TD(DANCE_25),                                   TD(DANCE_26),   KC_PERC,        KC_RPRN,        KC_RBRC,        KC_EXLM,        CW_TOGG,        
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRC),                                  RALT(KC_RBRC),  ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_38),   KC_TRANSPARENT, 
    KC_CAPS,        KC_QUES,        KC_LCBR,        RALT(LSFT(KC_S)),TD(DANCE_32),   ST_MACRO_7,                                     ST_MACRO_10,    TD(DANCE_39),   ST_MACRO_11,    KC_RCBR,        ST_MACRO_12,    OSM(MOD_RSFT),  
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_B,           FR_EACU,        KC_P,           KC_O,           FR_EGRV,                                        FR_Q,           KC_D,           KC_L,           KC_J,           FR_Z,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_40),                                   KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_41),   KC_K,                                           FR_CCED,        KC_G,           KC_H,           KC_F,           FR_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(8),          KC_C,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_V,           TT(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, FR_UNDS,        FR_LBRC,        FR_LPRN,        FR_EQL,         TD(DANCE_42),                                   TD(DANCE_43),   FR_PERC,        FR_RPRN,        FR_RBRC,        FR_EXLM,        CW_TOGG,        
  ...
  [8] = LAYOUT_voyager(
    ...
    KC_CAPS,        FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_49),   ST_MACRO_14,                                    ST_MACRO_17,    TD(DANCE_56),   ST_MACRO_18,    FR_RCBR,        FR_UGRV,        OSM(MOD_RSFT),  
  ...
  [9] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_KP_DOT,      KC_MS_WH_UP,                                    KC_MS_WH_DOWN,  TD(DANCE_68),   TD(DANCE_69),   TD(DANCE_70),   KC_KP_COMMA,    KC_NUM,         
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [2] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {62,219,138}, {225,224,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {0,245,245}, {62,219,138}, {62,219,138}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {225,224,255} },
    ...
    [5] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {74,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {0,245,245}, {74,255,255}, {74,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {225,224,255} },
    ...
    [7] = { {0,0,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {46,215,244}, {62,219,138}, {0,0,255}, {62,219,138}, {225,224,255}, {225,224,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {0,245,245}, {62,219,138}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {62,219,138} },

    [8] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {152,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {0,245,245}, {152,255,255}, {152,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {225,224,255} },
...
tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_59] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_59_finished, dance_59_reset),
        [DANCE_60] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_60_finished, dance_60_reset),
