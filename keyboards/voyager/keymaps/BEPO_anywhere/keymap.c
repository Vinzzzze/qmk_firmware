...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),    TT(2),          BP_C,           KC_BSPACE,                                      TD(DANCE_7),    BP_W,           TT(1),          KC_LEFT,        KC_RIGHT,       OSM(MOD_RGUI),  
                                                    KC_ENTER,       TD(DANCE_6),                                    MT(MOD_RCTL, KC_ESCAPE),KC_SPACE
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, BP_PIPE,        BP_AMPR,        BP_MINS,        BP_ASTR,        BP_LESS,                                        BP_GRTR,        BP_SLSH,        BP_PLUS,        BP_HASH,        BP_BSLS,        KC_TRANSPARENT, 
    KC_DELETE,      BP_6,           BP_4,           BP_8,           BP_0,           BP_2,                                           BP_3,           BP_1,           BP_9,           BP_5,           BP_7,           KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),                                   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   TD(DANCE_21),   KC_TRANSPARENT, 
    KC_DELETE,      BP_AT,          BP_TILD,        RALT(BP_COMM),  BP_APOS,        BP_LGIL,                                        BP_RGIL,        BP_GRV,         BP_DQOT,        BP_DTRM,        TD(DANCE_22),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_16),   RALT(BP_2),                                     RALT(BP_3),     TD(DANCE_23),   BP_MDSH,        BP_RCBR,        BP_UGRV,        TD(DANCE_24),   
  ...
  [3] = LAYOUT_voyager(
    ...
    TD(DANCE_25),   KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_26),                                   KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_3,     KC_Y,           KC_X,           TD(DANCE_27),   KC_K,                                           KC_Q,           KC_G,           KC_H,           KC_F,           ST_MACRO_4,     KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_DELETE,      KC_6,           KC_4,           KC_8,           KC_0,           KC_2,                                           KC_3,           KC_1,           KC_9,           KC_5,           KC_7,           KC_TRANSPARENT, 
    TD(DANCE_28),   KC_UNDS,        KC_LBRACKET,    KC_LPRN,        KC_EQUAL,       TD(DANCE_29),                                   TD(DANCE_30),   KC_PERC,        KC_RPRN,        KC_RBRACKET,    KC_EXLM,        CAPS_WORD,      
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, TD(DANCE_31),   TD(DANCE_32),   TD(DANCE_33),   TD(DANCE_34),   TD(DANCE_35),                                   TD(DANCE_37),   TD(DANCE_38),   TD(DANCE_39),   TD(DANCE_40),   TD(DANCE_41),   KC_TRANSPARENT, 
    KC_DELETE,      KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRACKET),                                RALT(KC_RBRACKET),ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_42),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    KC_QUES,        KC_LCBR,        RALT(LSFT(KC_S)),TD(DANCE_36),   ST_MACRO_7,                                     ST_MACRO_10,    TD(DANCE_43),   ST_MACRO_11,    KC_RCBR,        ST_MACRO_12,    TD(DANCE_44),   
  ...
  [6] = LAYOUT_voyager(
    ...
    TD(DANCE_45),   FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_46),                                   KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_47),   KC_K,                                           FR_Q,           KC_G,           KC_H,           KC_F,           FR_CCED,        KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_voyager(
    ...
    KC_DELETE,      FR_6,           FR_4,           FR_8,           FR_0,           FR_2,                                           FR_3,           FR_1,           FR_9,           FR_5,           FR_7,           KC_TRANSPARENT, 
    TD(DANCE_48),   FR_UNDS,        FR_LBRC,        FR_LPRN,        FR_EQL,         TD(DANCE_49),                                   TD(DANCE_50),   FR_PERC,        FR_RPRN,        FR_RBRC,        FR_EXLM,        CAPS_WORD,      
  ...
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, TD(DANCE_51),   TD(DANCE_52),   TD(DANCE_53),   TD(DANCE_54),   TD(DANCE_55),                                   TD(DANCE_57),   TD(DANCE_58),   TD(DANCE_59),   TD(DANCE_60),   TD(DANCE_61),   KC_TRANSPARENT, 
    KC_DELETE,      FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        ST_MACRO_13,                                    ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        FR_UMLT,        TD(DANCE_62),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_56),   ST_MACRO_14,                                    ST_MACRO_17,    TD(DANCE_63),   ST_MACRO_18,    FR_RCBR,        FR_UGRV,        TD(DANCE_64),   
  ...
  [9] = LAYOUT_voyager(
    KC_TRANSPARENT, TD(DANCE_65),   TD(DANCE_66),   TD(DANCE_67),   TD(DANCE_68),   TD(DANCE_69),                                   TD(DANCE_73),   TD(DANCE_74),   TD(DANCE_75),   TD(DANCE_76),   TD(DANCE_77),   KC_MS_UP,       
    TD(DANCE_70),   KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,                                        KC_KP_3,        KC_KP_1,        KC_KP_9,        KC_KP_5,        KC_KP_7,        KC_MS_DOWN,     
    KC_LSHIFT,      TO(0),          KC_MS_BTN1,     KC_MS_BTN2,     KC_AUDIO_MUTE,  KC_MS_WH_UP,                                    KC_MS_WH_DOWN,  TD(DANCE_78),   TD(DANCE_79),   TD(DANCE_80),   KC_KP_COMMA,    KC_NUMLOCK,     
    KC_TRANSPARENT, TD(DANCE_71),   TD(DANCE_72),   RGB_TOG,        TOGGLE_LAYER_COLOR,KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_81),   TD(DANCE_82),   KC_MS_LEFT,     KC_MS_RIGHT,    KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_KP_DOT
  ),
};
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [0] = { {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {74,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {0,245,245}, {74,255,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {74,255,255} },

    [1] = { {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {225,224,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {168,218,204}, {225,224,255}, {225,224,255}, {19,245,255}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {0,245,245}, {0,245,245}, {168,218,204}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {168,218,204} },
    ...
    [3] = { {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,245,245}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,245,245}, {131,255,255}, {131,255,255}, {0,0,255}, {131,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,245,245}, {0,245,245}, {131,255,255}, {0,0,255}, {131,255,255}, {131,255,255}, {0,245,245}, {225,224,255}, {131,255,255} },

    [4] = { {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {225,224,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {0,245,245}, {46,215,244}, {19,245,255}, {0,0,255}, {19,245,255}, {225,224,255}, {225,224,255}, {152,255,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {0,245,245}, {0,245,245}, {19,245,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255} },
    ...
    [6] = { {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,245,245}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {198,255,255}, {152,255,255}, {152,255,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,245,245}, {0,245,245}, {198,255,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {152,255,255}, {198,255,255} },

    [7] = { {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {46,215,244}, {62,219,138}, {0,0,255}, {62,219,138}, {225,224,255}, {225,224,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {0,245,245}, {62,219,138}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {62,219,138} },
    ...
    [9] = { {62,219,138}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {225,224,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {0,0,255}, {19,245,255}, {19,245,255}, {0,245,245}, {46,215,244}, {0,245,245}, {46,215,244}, {46,215,244}, {74,255,255}, {74,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {46,215,244}, {19,245,255}, {74,255,255}, {19,245,255}, {62,219,138}, {188,255,255}, {0,245,245}, {152,255,255}, {152,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {62,219,138} },
...
qk_tap_dance_action_t tap_dance_actions[] = {
        [DANCE_0] = ACTION_TAP_DANCE_TAP_HOLD(BP_DCRC, BP_DTRM),
        [DANCE_1] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, BP_SCLN),
        [DANCE_2] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_COLN),
        [DANCE_4] = ACTION_TAP_DANCE_TAP_HOLD(KC_PGUP, KC_HOME),
        [DANCE_5] = ACTION_TAP_DANCE_TAP_HOLD(KC_PGDOWN, KC_END),
        [DANCE_9] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_EURO),
        [DANCE_10] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, LSFT(RALT(BP_L))),
        [DANCE_16] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_EURO),
        [DANCE_22] = ACTION_TAP_DANCE_TAP_HOLD(BP_DEGR, RALT(BP_EGRV)),
        [DANCE_23] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, LSFT(RALT(BP_L))),
        [DANCE_25] = ACTION_TAP_DANCE_TAP_HOLD(KC_CIRC, KC_DQUO),
        [DANCE_26] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, KC_SCOLON),
        [DANCE_27] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, KC_COLN),
        [DANCE_29] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, RALT(KC_5)),
        [DANCE_30] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, RALT(RSFT(KC_4))),
        [DANCE_36] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, RALT(KC_5)),
        [DANCE_42] = ACTION_TAP_DANCE_TAP_HOLD(LSFT(RALT(KC_SCOLON)), KC_GRAVE),
        [DANCE_43] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, LSFT(RALT(KC_4))),
        [DANCE_45] = ACTION_TAP_DANCE_TAP_HOLD(FR_CIRC, FR_UMLT),
        [DANCE_46] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_SCLN),
        [DANCE_47] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_COLN),
        [DANCE_49] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_EURO),
        [DANCE_50] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_PND),
        [DANCE_56] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_EURO),
        [DANCE_62] = ACTION_TAP_DANCE_TAP_HOLD(FR_OVRR, FR_GRV),
        [DANCE_63] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_PND),
        [DANCE_70] = ACTION_TAP_DANCE_TAP_HOLD(KC_DELETE, LALT(LCTL(KC_DELETE))),
        [DANCE_78] = ACTION_TAP_DANCE_TAP_HOLD(KC_MEDIA_PREV_TRACK, KC_MEDIA_REWIND),
        [DANCE_80] = ACTION_TAP_DANCE_TAP_HOLD(KC_MEDIA_NEXT_TRACK, KC_MEDIA_FAST_FORWARD),
