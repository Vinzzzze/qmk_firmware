...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F6,          KC_F4,          KC_F8,          KC_F10,         KC_F2,                                          KC_F3,          KC_F9,          KC_F1,          KC_F5,          KC_F7,          KC_TRANSPARENT, 
    KC_TRANSPARENT, BP_AT,          BP_TILD,        RALT(BP_COMM),  BP_APOS,        BP_LGIL,                                        BP_RGIL,        BP_GRV,         BP_DQOT,        BP_DTRM,        TD(DANCE_11),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_10),   RALT(BP_2),                                     RALT(BP_3),     TD(DANCE_12),   BP_MDSH,        BP_RCBR,        BP_UGRV,        TD(DANCE_13),   
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_14),                                   KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F6,          KC_F4,          KC_F8,          KC_F10,         KC_F2,                                          KC_F3,          KC_F9,          KC_F1,          KC_F5,          KC_F7,          KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRACKET),                                RALT(KC_RBRACKET),ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_20),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    KC_QUES,        KC_LCBR,        RALT(LSFT(KC_S)),TD(DANCE_19),   ST_MACRO_7,                                     ST_MACRO_10,    TD(DANCE_21),   ST_MACRO_11,    KC_RCBR,        ST_MACRO_12,    TD(DANCE_22),   
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_23),                                   KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F6,          KC_F4,          KC_F8,          KC_F10,         KC_F2,                                          KC_F3,          KC_F9,          KC_F1,          KC_F5,          KC_F7,          KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        ST_MACRO_13,                                    ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        FR_UMLT,        TD(DANCE_29),   KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_voyager(
    RGB_TOG,        KC_F6,          KC_F4,          KC_F8,          KC_F10,         KC_F2,                                          KC_F3,          KC_F9,          KC_F1,          KC_F5,          KC_F7,          KC_TRANSPARENT, 
    ...
    TD(DANCE_32),   KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,     KC_LALT,        KC_TRANSPARENT,                                 RESET,          TD(DANCE_36),   TD(DANCE_37),   KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_38),   
...
qk_tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_12] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, LSFT(RALT(BP_L))),
        ...
        [DANCE_21] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, LSFT(RALT(KC_4))),
