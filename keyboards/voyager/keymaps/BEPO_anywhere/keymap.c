...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    OSM(MOD_LSFT),  BP_AGRV,        BP_Y,           BP_X,           TD(DANCE_1),    KC_BSPC,                                        TD(DANCE_6),    BP_G,           BP_H,           BP_F,           BP_W,           OSM(MOD_RSFT),  
    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    TT(2),          BP_C,           BP_CCED,                                        BP_K,           KC_SPACE,           TT(1),          KC_LEFT,        KC_RIGHT,       OSM(MOD_RGUI),  
                                                    KC_ENTER,       TD(DANCE_5),                                    TD(DANCE_7),    BP_Q
  ),
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, BP_DCRC,        BP_LESS,                                        TD(DANCE_10),   KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, BP_DCRC,        RALT(BP_2),                                     RALT(BP_3),     KC_ESCAPE,         ST_MACRO_0,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_16),                                   KC_TRANSPARENT, BP_DLR
  ),
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, ST_MACRO_3,     KC_Y,           KC_X,           TD(DANCE_24),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           KC_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(5),          KC_C,           ST_MACRO_4,                                     KC_K,           KC_TRANSPARENT,           TT(4),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_Q
  ),
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        KC_LABK,                                        TD(DANCE_27),   KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        ST_MACRO_6,                                     ST_MACRO_11,    KC_ESCAPE,         RALT(KC_M),     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_33),                                   KC_TRANSPARENT, KC_DLR
  ),
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_41),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           FR_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(8),          KC_C,           FR_CCED,                                        KC_K,           KC_TRANSPARENT,           TT(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, FR_Q
  ),
  [7] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, FR_CCIRC,       FR_LESS,                                        TD(DANCE_44),   KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, FR_CCIRC,       ST_MACRO_14,                                    ST_MACRO_19,    KC_ESCAPE,         FR_MU,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_50),                                   KC_TRANSPARENT, FR_DLR
  ),
  [9] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, ST_MACRO_22,    KC_Y,           KC_X,           TD(DANCE_58),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           KC_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(11),         KC_C,           ST_MACRO_23,                                    KC_K,           KC_TRANSPARENT,           TT(10),         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_Q
  ),
  [10] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_6,           KC_4,           KC_8,           KC_0,           KC_2,                                           KC_3,           KC_1,           KC_9,           KC_5,           KC_7,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_UNDS,        KC_LBRC,        KC_LPRN,        KC_EQUAL,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_PERC,        KC_RPRN,        KC_RBRC,        KC_EXLM,        CW_TOGG,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        KC_LABK,                                        TD(DANCE_61),   KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_RABK,        KC_ENTER,                                       KC_TRANSPARENT, KC_DLR
  ),
  [11] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CIRC,        RALT(KC_LBRC),                                  RALT(RSFT(KC_LBRC)),KC_ESCAPE,         RALT(KC_M),     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_ENTER,       TD(DANCE_67),                                   KC_TRANSPARENT, KC_DLR
  ),
  [12] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_RIGHT, RGB_TOG,        TOGGLE_LAYER_COLOR,KC_MS_WH_UP,                                    KC_MS_WH_DOWN,  KC_TRANSPARENT,   TD(DANCE_88),   KC_MS_LEFT,     KC_MS_RIGHT,    KC_TRANSPARENT, 
                                                    KC_KP_ENTER,    KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_87)
  ),
};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [5] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {74,255,255}, {74,255,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {225,224,255}, {74,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {74,255,255} },
    ...
    [9] = { {225,224,255}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,245,245}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {225,224,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {0,219,138}, {0,219,138}, {225,224,255}, {19,245,255}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {46,215,244}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {46,215,244}, {0,245,245}, {0,219,138}, {0,219,138}, {0,219,138}, {0,219,138}, {0,245,245}, {0,219,138}, {0,219,138}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {0,219,138} },

    [10] = { {0,0,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {46,215,244}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {62,219,138}, {62,219,138}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {62,219,138} },

    [11] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {0,245,245}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {225,224,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {172,234,170}, {172,234,170}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {46,215,244}, {0,245,245}, {172,234,170}, {172,234,170}, {172,234,170}, {172,234,170}, {0,245,245}, {172,234,170}, {225,224,255}, {172,234,170}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {172,234,170} },

    [12] = { {225,224,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {19,245,255}, {19,245,255}, {19,245,255}, {62,219,138}, {225,224,255}, {0,245,245}, {46,215,244}, {46,215,244}, {74,255,255}, {74,255,255}, {46,215,244}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {0,245,245}, {19,245,255}, {74,255,255}, {19,245,255}, {62,219,138}, {188,255,255}, {46,215,244}, {62,219,138}, {152,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {152,255,255} },
