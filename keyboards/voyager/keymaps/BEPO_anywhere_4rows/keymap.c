...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_ESCAPE,      BP_B,           BP_ECUT,        BP_P,           BP_O,           KC_BSPC,                                        TD(DANCE_6),    BP_D,           BP_L,           BP_J,           BP_Z,           KC_UP,          
    KC_TAB,         BP_A,           BP_U,           BP_I,           BP_E,           KC_ENTER,                                       KC_SPACE,       BP_S,           BP_R,           BP_N,           BP_M,           KC_DOWN,        
    OSM(MOD_LSFT),  BP_AGRV,        BP_Y,           BP_X,           TD(DANCE_0),    TD(DANCE_1),                                    TD(DANCE_7),    BP_G,           BP_H,           BP_F,           BP_W,           OSM(MOD_RSFT),  
    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    TT(2),          BP_C,           BP_K,                                           BP_CCED,        BP_Q,           TT(1),          KC_LEFT,        KC_RIGHT,       OSM(MOD_RGUI),  
                                                    BP_EGRV,        TD(DANCE_5),                                    BP_V,           BP_T
  ),
  [1] = LAYOUT_voyager(
    TO(9),          BP_PIPE,        BP_AMPR,        BP_MINS,        BP_ASTR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, BP_SLSH,        BP_PLUS,        BP_HASH,        BP_BSLS,        KC_TRANSPARENT, 
    KC_TRANSPARENT, BP_6,           BP_4,           BP_8,           BP_0,           KC_TRANSPARENT,                                 KC_TRANSPARENT, BP_1,           BP_9,           BP_5,           BP_7,           KC_TRANSPARENT, 
    KC_TRANSPARENT, BP_UNDS,        BP_LBRC,        BP_LPRN,        BP_EQL,         KC_TRANSPARENT,                                 KC_TRANSPARENT, BP_PERC,        BP_RPRN,        BP_RBRC,        BP_EXLM,        CW_TOGG,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, BP_LESS,        BP_GRTR,                                        TD(DANCE_8),    BP_DCRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    BP_2,           BP_3,                                           BP_DLR,         TD(DANCE_9)
  ),
  [2] = LAYOUT_voyager(
    KC_DELETE,      TD(DANCE_10),   TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),                                   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   TD(DANCE_21),   KC_TRANSPARENT, 
    KC_TRANSPARENT, BP_AT,          BP_TILD,        RALT(BP_COMM),  BP_APOS,        KC_TRANSPARENT,                                 KC_TRANSPARENT, BP_GRV,         BP_DQOT,        BP_DTRM,        TD(DANCE_22),   KC_TRANSPARENT, 
    KC_CAPS,        BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_15),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_23),   BP_MDSH,        BP_RCBR,        BP_UGRV,        OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_0,     TD(DANCE_16),                                   BP_DCRC,        BP_DLR,         KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    RALT(BP_2),     RALT(BP_3),                                     BP_LGIL,        BP_RGIL
  ),
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_B,           ST_MACRO_1,     KC_P,           BP_O,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_D,           KC_L,           KC_J,           KC_Z,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_A,           KC_U,           KC_I,           KC_E,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_2,     KC_Y,           KC_X,           TD(DANCE_24),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           KC_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(5),          KC_C,           KC_K,                                           ST_MACRO_4,     KC_Q,           TT(4),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    ST_MACRO_3,     TD(DANCE_25),                                   KC_V,           KC_T
  ),
  [4] = LAYOUT_voyager(
    TO(9),          KC_PIPE,        KC_AMPR,        KC_MINUS,       KC_ASTR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_SLASH,       KC_PLUS,        KC_HASH,        KC_BSLS,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_6,           KC_4,           KC_8,           KC_0,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_1,           KC_9,           KC_5,           KC_7,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_UNDS,        KC_LBRC,        KC_LPRN,        KC_EQUAL,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_PERC,        KC_RPRN,        KC_RBRC,        KC_EXLM,        CW_TOGG,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LABK,        KC_RABK,                                        TD(DANCE_26),   KC_CIRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_2,           KC_3,                                           KC_DLR,         TD(DANCE_27)
  ),
  [5] = LAYOUT_voyager(
    KC_DELETE,      TD(DANCE_28),   TD(DANCE_29),   TD(DANCE_30),   TD(DANCE_31),   TD(DANCE_32),                                   TD(DANCE_35),   TD(DANCE_36),   TD(DANCE_37),   TD(DANCE_38),   TD(DANCE_39),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_9,     ST_MACRO_10,    KC_DQUO,        TD(DANCE_40),   KC_TRANSPARENT, 
    KC_CAPS,        KC_QUES,        KC_LCBR,        RALT(LSFT(KC_S)),TD(DANCE_33),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_41),   ST_MACRO_11,    KC_RCBR,        ST_MACRO_12,    OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RALT(KC_M),     TD(DANCE_34),                                   KC_CIRC,        KC_DLR,         KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    ST_MACRO_7,     ST_MACRO_8,                                     RALT(KC_LBRC),  RALT(KC_RBRC)
  ),
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_B,           FR_EACU,        KC_P,           KC_O,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_D,           KC_L,           KC_J,           FR_Z,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_42),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           FR_W,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(8),          KC_C,           KC_K,                                           FR_CCED,        FR_Q,           TT(7),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    FR_EGRV,        TD(DANCE_43),                                   KC_V,           KC_T
  ),
  [7] = LAYOUT_voyager(
    TO(9),          FR_PIPE,        FR_AMP,         FR_MINS,        FR_ASTR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, FR_SLSH,        FR_PLUS,        FR_HASH,        FR_BSLS,        KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_6,           FR_4,           FR_8,           FR_0,           KC_TRANSPARENT,                                 KC_TRANSPARENT, FR_1,           FR_9,           FR_5,           FR_7,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_UNDS,        FR_LBRC,        FR_LPRN,        FR_EQL,         KC_TRANSPARENT,                                 KC_TRANSPARENT, FR_PERC,        FR_RPRN,        FR_RBRC,        FR_EXLM,        CW_TOGG,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, FR_LESS,        FR_GRTR,                                        TD(DANCE_44),   FR_CCIRC,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    FR_2,           FR_3,                                           FR_DLR,         TD(DANCE_45)
  ),
  [8] = LAYOUT_voyager(
    KC_DELETE,      TD(DANCE_46),   TD(DANCE_47),   TD(DANCE_48),   TD(DANCE_49),   TD(DANCE_50),                                   TD(DANCE_53),   TD(DANCE_54),   TD(DANCE_55),   TD(DANCE_56),   TD(DANCE_57),   KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_15,    FR_DQUO,        FR_UMLT,        TD(DANCE_58),   KC_TRANSPARENT, 
    KC_CAPS,        FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_51),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_59),   ST_MACRO_16,    FR_RCBR,        FR_UGRV,        OSM(MOD_RSFT),  
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, FR_MU,          TD(DANCE_52),                                   FR_CCIRC,       FR_DLR,         KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    ST_MACRO_13,    ST_MACRO_14,                                    ST_MACRO_17,    ST_MACRO_18
  ),
  [9] = LAYOUT_voyager(
    TD(DANCE_60),   TD(DANCE_61),   TD(DANCE_62),   TD(DANCE_63),   TD(DANCE_64),   TD(DANCE_65),                                   TD(DANCE_66),   TD(DANCE_67),   TD(DANCE_68),   TD(DANCE_69),   TD(DANCE_70),   KC_MS_UP,       
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,                                        KC_KP_3,        KC_KP_1,        KC_KP_9,        KC_KP_5,        KC_KP_7,        KC_MS_DOWN,     
    KC_LEFT_SHIFT,  KC_MS_BTN1,     KC_MS_BTN3,     KC_MS_BTN2,     KC_KP_DOT,      KC_MS_WH_UP,                                    KC_MS_WH_DOWN,  TD(DANCE_71),   TD(DANCE_72),   TD(DANCE_73),   KC_KP_COMMA,    KC_NUM,         
    KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_RIGHT, RGB_TOG,        TOGGLE_LAYER_COLOR,KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_74),   TD(DANCE_75),   KC_MS_LEFT,     KC_MS_RIGHT,    KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [0] = { {225,224,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {74,255,255}, {74,255,255} },

    [1] = { {0,0,255}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {225,224,255}, {168,218,204}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {0,245,245}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {168,218,204}, {168,218,204}, {62,219,138}, {62,219,138}, {0,245,245}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {46,215,244}, {168,218,204}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {19,245,255}, {168,218,204}, {168,218,204}, {168,218,204}, {168,218,204}, {0,245,245}, {168,218,204}, {168,218,204}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {168,218,204}, {168,218,204} },

    [2] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {62,219,138}, {0,245,245}, {62,219,138}, {62,219,138}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {62,219,138}, {62,219,138}, {225,224,255}, {46,215,244}, {46,215,244}, {0,245,245}, {62,219,138}, {62,219,138} },

    [3] = { {225,224,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {225,224,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {225,224,255}, {0,245,245}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {19,245,255}, {0,245,245}, {131,255,255}, {131,255,255}, {0,0,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,245,245}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,245,245}, {131,255,255}, {131,255,255}, {0,0,255}, {131,255,255}, {131,255,255}, {0,245,245}, {131,255,255}, {131,255,255} },

    [4] = { {0,0,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {225,224,255}, {19,245,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {225,224,255}, {0,245,245}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {152,255,255}, {0,245,245}, {46,215,244}, {19,245,255}, {0,0,255}, {19,245,255}, {19,245,255}, {152,255,255}, {152,255,255}, {0,245,245}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {19,245,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {152,255,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {0,245,245}, {19,245,255}, {19,245,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {19,245,255} },

    [5] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {0,245,245}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,245,245}, {74,255,255}, {74,255,255}, {225,224,255}, {46,215,244}, {46,215,244}, {0,245,245}, {74,255,255}, {74,255,255} },

    [6] = { {152,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {152,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {152,255,255}, {0,245,245}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,245,245}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,245,245}, {198,255,255}, {198,255,255}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {198,255,255}, {198,255,255} },

    [7] = { {0,0,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {225,224,255}, {62,219,138}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {225,224,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {19,245,255}, {0,245,245}, {46,215,244}, {62,219,138}, {0,0,255}, {62,219,138}, {62,219,138}, {152,255,255}, {152,255,255}, {0,245,245}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {62,219,138}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {62,219,138}, {62,219,138}, {0,0,255}, {46,215,244}, {46,215,244}, {0,245,245}, {62,219,138}, {62,219,138} },

    [8] = { {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {225,224,255}, {0,245,245}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {19,245,255}, {0,245,245}, {46,215,244}, {46,215,244}, {0,0,255}, {152,255,255}, {0,245,245}, {152,255,255}, {152,255,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {46,215,244}, {19,245,255}, {152,255,255}, {152,255,255}, {152,255,255}, {152,255,255}, {0,245,245}, {152,255,255}, {152,255,255}, {225,224,255}, {46,215,244}, {46,215,244}, {0,245,245}, {152,255,255}, {152,255,255} },

    [9] = { {225,224,255}, {0,0,255}, {0,0,255}, {0,0,255}, {19,245,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {0,245,245}, {19,245,255}, {19,245,255}, {19,245,255}, {62,219,138}, {46,215,244}, {0,245,245}, {46,215,244}, {46,215,244}, {74,255,255}, {74,255,255}, {225,224,255}, {225,224,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {19,245,255}, {46,215,244}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {46,215,244}, {46,215,244}, {19,245,255}, {74,255,255}, {19,245,255}, {62,219,138}, {188,255,255}, {0,245,245}, {152,255,255}, {152,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {62,219,138} },
...
void dance_41_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[41].step) {
        case SINGLE_TAP: register_code16(KC_COMMA); break;
        case SINGLE_HOLD: register_code16(LSFT(RALT(KC_4))); break;
        case DOUBLE_TAP: register_code16(KC_COMMA); register_code16(KC_COMMA); break;
        case DOUBLE_SINGLE_TAP: tap_code16(KC_COMMA); register_code16(KC_COMMA);
    }
}
...
void dance_41_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[41].step) {
        case SINGLE_TAP: unregister_code16(KC_COMMA); break;
        case SINGLE_HOLD: unregister_code16(LSFT(RALT(KC_4))); break;
        case DOUBLE_TAP: unregister_code16(KC_COMMA); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(KC_COMMA); break;
    }
...
tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_61] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_61_finished, dance_61_reset),
        [DANCE_62] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_62_finished, dance_62_reset),
        [DANCE_63] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_63_finished, dance_63_reset),
