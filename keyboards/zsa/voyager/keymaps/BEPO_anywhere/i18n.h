...
/**
 * Add define for the vince's specific code :
 * VM_USE_NUMPAD_ONLY : to make all the num keys numpad keys
 * VM_USE_LEFTPAD_ONLY : to make the keyboard usable even if only the left part is connected
*/
#define VM_USE_NUMPAD_ONLY
#define VM_APPLICATION_WEB_LAYER 9
#define VM_APPLICATION_WEB_ALT_LAYER1 0
#define VM_APPLICATION_WEB_ALT_LAYER2 1
#define FUNCTION_LAYER 10
/* #define VM_USE_LEFTPAD_ONLY 12 */
/* #define VM_USE_DOUBLE_SHIFT_CAPS_WORD */
