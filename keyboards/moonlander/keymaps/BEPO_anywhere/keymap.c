...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TD(DANCE_6),    BP_A,           BP_U,           BP_I,           BP_E,           TD(DANCE_7),    KC_MS_WH_LEFT,                                                                  KC_MS_WH_RIGHT, BP_T,           BP_S,           BP_R,           BP_N,           BP_M,           KC_DOWN,        
    OSM(MOD_LSFT),  BP_AGRV,        BP_Y,           BP_X,           TD(DANCE_8),    BP_K,                                           BP_Q,           BP_G,           BP_H,           BP_F,           BP_CCED,        OSM(MOD_RSFT),  
    TD(DANCE_9),    TD(DANCE_10),   TD(DANCE_11),   TT(2),          BP_C,           TD(DANCE_12),                                                                                                   TD(DANCE_20),   BP_W,           TT(1),          KC_LEFT,        KC_RIGHT,       OSM(MOD_RGUI),  
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_DELETE,      BP_6,           BP_4,           BP_8,           BP_0,           BP_2,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, BP_3,           BP_1,           BP_9,           BP_5,           BP_7,           KC_TRANSPARENT, 
    TD(DANCE_21),   BP_UNDS,        BP_LBRC,        BP_LPRN,        BP_EQL,         TD(DANCE_22),                                   TD(DANCE_23),   BP_PERC,        BP_RPRN,        BP_RBRC,        BP_EXLM,        CAPS_WORD,      
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, TD(DANCE_24),   TD(DANCE_25),   TD(DANCE_26),   TD(DANCE_27),   TD(DANCE_28),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_30),   TD(DANCE_31),   TD(DANCE_32),   TD(DANCE_33),   TD(DANCE_34),   KC_TRANSPARENT, 
    KC_DELETE,      BP_AT,          BP_TILD,        RALT(BP_COMM),  BP_APOS,        BP_LGIL,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, BP_RGIL,        BP_GRV,         BP_DQOT,        BP_DTRM,        TD(DANCE_35),   KC_TRANSPARENT, 
    KC_CAPSLOCK,    BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_29),   RALT(BP_2),                                     RALT(BP_3),     TD(DANCE_36),   RALT(BP_DQOT),  BP_RCBR,        BP_UGRV,        TD(DANCE_37),   
  ...
  [3] = LAYOUT_moonlander(
    ...
    TD(DANCE_38),   KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_39),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_DELETE,      KC_6,           KC_4,           KC_8,           KC_0,           KC_2,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_3,           KC_1,           KC_9,           KC_5,           KC_7,           KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_moonlander(
    ...
    KC_DELETE,      KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRACKET),KC_TRANSPARENT,                                                                 KC_TRANSPARENT, RALT(KC_RBRACKET),ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_55),   KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_moonlander(
    ...
    TD(DANCE_58),   FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_59),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_moonlander(
    ...
    KC_DELETE,      FR_6,           FR_4,           FR_8,           FR_0,           FR_2,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, FR_3,           FR_1,           FR_9,           FR_5,           FR_7,           KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_moonlander(
    ...
    KC_DELETE,      FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        ST_MACRO_13,    KC_TRANSPARENT,                                                                 KC_TRANSPARENT, ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        FR_UMLT,        TD(DANCE_75),   KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_moonlander(
    TD(DANCE_78),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_BSPACE,                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_80),   
    ...
    TD(DANCE_79),   TO(6),          KC_LEFT,        KC_HOME,        KC_RIGHT,       KC_AUDIO_VOL_DOWN,KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_KP_MINUS,    KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_PLUS,     KC_MS_DOWN,     
    KC_LSHIFT,      KC_NUMLOCK,     KC_PGDOWN,      KC_DOWN,        KC_END,         KC_LALT,                                        TO(3),          KC_KP_1,        KC_KP_2,        KC_KP_3,        TD(DANCE_81),   KC_RSHIFT,      
...
qk_tap_dance_action_t tap_dance_actions[] = {
        [DANCE_6] = ACTION_TAP_DANCE_TAP_HOLD(BP_DCRC, BP_DTRM),
        [DANCE_7] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, BP_SCLN),
        [DANCE_8] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_COLN),
        [DANCE_10] = ACTION_TAP_DANCE_TAP_HOLD(KC_PGUP, KC_HOME),
        [DANCE_11] = ACTION_TAP_DANCE_TAP_HOLD(KC_PGDOWN, KC_END),
        [DANCE_22] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_EURO),
        [DANCE_23] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, RALT(RSFT(BP_L))),
        [DANCE_29] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_EURO),
        [DANCE_35] = ACTION_TAP_DANCE_TAP_HOLD(BP_DEGR, RALT(BP_EGRV)),
        [DANCE_36] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, RALT(RSFT(BP_L))),
        [DANCE_38] = ACTION_TAP_DANCE_TAP_HOLD(KC_CIRC, KC_DQUO),
        ...
        [DANCE_58] = ACTION_TAP_DANCE_TAP_HOLD(FR_CIRC, FR_UMLT),
        ...
        [DANCE_79] = ACTION_TAP_DANCE_TAP_HOLD(KC_DELETE, LALT(LCTL(KC_DELETE))),
        [DANCE_80] = ACTION_TAP_DANCE_TAP_HOLD(KC_MEDIA_NEXT_TRACK, KC_MEDIA_FAST_FORWARD),
        [DANCE_81] = ACTION_TAP_DANCE_TAP_HOLD(KC_KP_DOT, KC_KP_COMMA),
