...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_moonlander(
    ...
    TO(9),          TD(DANCE_23),   TD(DANCE_24),   TD(DANCE_25),   TD(DANCE_26),   TD(DANCE_27),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_29),   TD(DANCE_30),   TD(DANCE_31),   TD(DANCE_32),   TD(DANCE_33),   KC_TRANSPARENT, 
    ...
    KC_CAPS,        BP_QEST,        BP_LCBR,        RALT(LSFT(BP_P)),TD(DANCE_28),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_35),   RALT(BP_DQOT),  BP_RCBR,        BP_UGRV,        OSM(MOD_RSFT),  
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_36),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_3,     KC_Y,           KC_X,           TD(DANCE_37),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           ST_MACRO_4,     KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_DELETE,      KC_PIPE,        KC_AMPR,        KC_MINUS,       KC_ASTR,        TD(DANCE_38),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_39),   KC_SLASH,       KC_PLUS,        KC_HASH,        KC_BSLS,        KC_TRANSPARENT, 
    ...
    KC_LABK,        KC_RABK,        KC_ENTER,                       KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_40)
  ),
  [5] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_KP_3,        KC_KP_1,        KC_KP_9,        KC_KP_5,        KC_KP_7,        KC_TRANSPARENT, 
    TO(9),          TD(DANCE_41),   TD(DANCE_42),   TD(DANCE_43),   TD(DANCE_44),   TD(DANCE_45),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_47),   TD(DANCE_48),   TD(DANCE_49),   TD(DANCE_50),   TD(DANCE_51),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRC),  KC_TRANSPARENT,                                                                 KC_TRANSPARENT, RALT(KC_RBRC),  ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_52),   KC_TRANSPARENT, 
    KC_CAPS,        KC_QUES,        KC_LCBR,        RALT(RSFT(KC_S)),TD(DANCE_46),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_53),   ST_MACRO_10,    KC_RCBR,        ST_MACRO_11,    OSM(MOD_RSFT),  
  ...
  [6] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_54),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_55),   KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_G,           KC_H,           KC_F,           FR_CCED,        KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_DELETE,      FR_PIPE,        FR_AMP,         FR_MINS,        FR_ASTR,        TD(DANCE_56),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_57),   FR_SLSH,        FR_PLUS,        FR_HASH,        FR_BSLS,        KC_TRANSPARENT, 
    ...
    FR_LESS,        FR_GRTR,        KC_ENTER,                       KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_58)
  ),
  [8] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_KP_3,        KC_KP_1,        KC_KP_9,        KC_KP_5,        KC_KP_7,        KC_TRANSPARENT, 
    TO(9),          TD(DANCE_59),   TD(DANCE_60),   TD(DANCE_61),   TD(DANCE_62),   TD(DANCE_63),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_65),   TD(DANCE_66),   TD(DANCE_67),   TD(DANCE_68),   TD(DANCE_69),   KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AT,          FR_TILD,        FR_APOS,        FR_SUP2,        ST_MACRO_13,    KC_TRANSPARENT,                                                                 KC_TRANSPARENT, ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        FR_UMLT,        TD(DANCE_70),   KC_TRANSPARENT, 
    KC_CAPS,        FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_64),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_71),   ST_MACRO_17,    FR_RCBR,        FR_UGRV,        OSM(MOD_RSFT),  
    ...
    ST_MACRO_14,    KC_ENTER,       KC_LEFT_CTRL,                   KC_ESCAPE,      KC_TRANSPARENT, ST_MACRO_18
  ),
  [9] = LAYOUT_moonlander(
    ...
    TD(DANCE_72),   TO(0),          KC_PAGE_UP,     KC_UP,          KC_AUDIO_MUTE,  KC_AUDIO_VOL_UP,DM_PLY1,                                        DM_PLY2,        KC_KP_SLASH,    KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_ASTERISK, KC_MS_UP,       
    ...
    KC_LEFT_SHIFT,  KC_NUM,         KC_PGDN,        KC_DOWN,        KC_END,         KC_LEFT_ALT,                                    TO(3),          KC_KP_1,        KC_KP_2,        KC_KP_3,        TD(DANCE_73),   KC_RIGHT_SHIFT, 
    ...
    MT(MOD_LCTL, KC_ESCAPE),KC_KP_ENTER,    DM_REC1,                        DM_REC2,        KC_TRANSPARENT, MT(MOD_RALT, KC_ESCAPE)
  ),
};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {188,255,255}, {225,224,255}, {168,218,204}, {0,245,245}, {0,245,245}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {41,255,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {41,255,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {0,0,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {168,218,204}, {19,245,255}, {168,218,204}, {78,218,204}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {168,218,204}, {168,218,204}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {46,215,244}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {46,215,244}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {0,0,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {168,218,204}, {19,245,255}, {168,218,204}, {78,218,204}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {19,245,255}, {168,218,204}, {19,245,255}, {0,245,245} },

    [2] = { {188,255,255}, {0,0,255}, {62,219,138}, {0,245,245}, {0,245,245}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {41,255,255}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {41,255,255}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {0,0,255}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {168,218,204}, {19,245,255}, {62,219,138}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {62,219,138}, {225,224,255}, {19,245,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {46,215,244}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {46,215,244}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {168,218,204}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {168,218,204}, {19,245,255}, {62,219,138}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {62,219,138}, {62,219,138}, {188,255,255}, {0,245,245} },
    ...
    [4] = { {188,255,255}, {225,224,255}, {1,181,132}, {0,245,245}, {0,245,245}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {41,255,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {41,255,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {0,0,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {1,181,132}, {19,245,255}, {1,181,132}, {74,255,255}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {1,181,132}, {1,181,132}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {46,215,244}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {46,215,244}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {0,0,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {1,181,132}, {19,245,255}, {1,181,132}, {74,255,255}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {1,181,132}, {1,181,132}, {152,255,255}, {0,245,245} },

    [5] = { {188,255,255}, {0,0,255}, {74,255,255}, {0,245,245}, {0,245,245}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {41,255,255}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {46,215,244}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {0,0,255}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {1,181,132}, {19,245,255}, {74,255,255}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {74,255,255}, {225,224,255}, {19,245,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {46,215,244}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {46,215,244}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {1,181,132}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {1,181,132}, {19,245,255}, {74,255,255}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {0,245,245} },
    ...
    [7] = { {188,255,255}, {225,224,255}, {62,219,138}, {0,245,245}, {0,245,245}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {41,255,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {41,255,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {0,0,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {131,255,255}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {62,219,138}, {62,219,138}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {0,0,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {131,255,255}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {62,219,138}, {62,219,138}, {19,245,255}, {0,245,245} },

    [8] = { {188,255,255}, {0,0,255}, {131,255,255}, {0,245,245}, {0,245,245}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {41,255,255}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {41,255,255}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {0,0,255}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {62,219,138}, {19,245,255}, {131,255,255}, {225,224,255}, {0,0,255}, {41,255,255}, {41,255,255}, {131,255,255}, {225,224,255}, {19,245,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {0,245,245}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {46,215,244}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {46,215,244}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {62,219,138}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {62,219,138}, {19,245,255}, {131,255,255}, {0,245,245}, {188,255,255}, {41,255,255}, {41,255,255}, {131,255,255}, {131,255,255}, {225,224,255}, {0,245,245} },

    [9] = { {188,255,255}, {225,224,255}, {62,219,138}, {0,245,245}, {19,245,255}, {19,245,255}, {0,0,255}, {0,0,255}, {0,245,245}, {41,255,255}, {19,245,255}, {0,245,245}, {19,245,255}, {0,245,245}, {41,255,255}, {19,245,255}, {19,245,255}, {0,245,245}, {19,245,255}, {131,255,255}, {19,245,255}, {0,245,245}, {19,245,255}, {0,245,245}, {0,245,245}, {19,245,255}, {131,255,255}, {131,255,255}, {0,245,245}, {225,224,255}, {74,255,255}, {41,255,255}, {19,245,255}, {225,224,255}, {0,245,245}, {41,255,255}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {19,245,255}, {19,245,255}, {1,181,132}, {1,181,132}, {1,181,132}, {46,215,244}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {41,255,255}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {62,219,138}, {62,219,138}, {41,255,255}, {19,245,255}, {1,181,132}, {1,181,132}, {0,0,255}, {188,255,255}, {74,255,255}, {41,255,255}, {0,245,245}, {62,219,138}, {0,245,245}, {41,255,255} },
