...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),    KC_DELETE,                                      TD(DANCE_14),   TD(DANCE_15),   TD(DANCE_16),   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   
    KC_TAB,         BP_B,           BP_ECUT,        BP_P,           BP_O,           BP_EGRV,        TD(DANCE_6),                                    KC_HOME,        BP_V,           BP_D,           BP_L,           BP_J,           BP_Z,           KC_UP,          
    KC_BSPACE,      BP_A,           BP_U,           BP_I,           BP_E,           TD(DANCE_7),    TD(DANCE_8),                                                                    KC_END,         BP_T,           BP_S,           BP_R,           BP_N,           BP_M,           KC_DOWN,        
    TD(DANCE_9),    BP_AGRV,        BP_Y,           BP_X,           TD(DANCE_10),   BP_K,                                           BP_Q,           BP_G,           BP_H,           BP_F,           BP_CCED,        TD(DANCE_21),   
    KC_LALT,        TD(DANCE_11),   TD(DANCE_12),   TT(2),          BP_C,           TD(DANCE_13),                                                                                                   TD(DANCE_23),   BP_W,           TT(1),          KC_LEFT,        KC_RIGHT,       TD(DANCE_22),   
    KC_ENTER,       KC_LCTRL,       KC_ESCAPE,                      MT(MOD_RCTL, KC_ESCAPE),KC_RALT,        KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, BP_UNDS,        BP_LBRC,        BP_LPRN,        BP_EQL,         TD(DANCE_24),                                   TD(DANCE_25),   BP_PERC,        BP_RPRN,        BP_RBRC,        BP_EXLM,        CAPS_WORD,      
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_UNDS,        KC_LBRACKET,    KC_LPRN,        KC_EQUAL,       TD(DANCE_32),                                   TD(DANCE_33),   KC_PERC,        KC_RPRN,        KC_RBRACKET,    KC_EXLM,        CAPS_WORD,      
  ...
  [5] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_AT,          ST_MACRO_5,     ST_MACRO_6,     KC_QUOTE,       RALT(KC_LBRACKET),KC_TRANSPARENT,                                 KC_TRANSPARENT, RALT(KC_RBRACKET),ST_MACRO_8,     ST_MACRO_9,     KC_DQUO,        TD(DANCE_35),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_KP_3,        KC_KP_9,        KC_KP_1,        KC_KP_5,        KC_KP_7,        KC_TRANSPARENT, 
    KC_CAPSLOCK,    KC_QUES,        KC_LCBR,        RALT(RSFT(KC_S)),TD(DANCE_34),   ST_MACRO_7,                                     ST_MACRO_10,    TD(DANCE_36),   ST_MACRO_11,    KC_RCBR,        ST_MACRO_12,    TD(DANCE_37),   
  ...
  [6] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_38),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_39),   KC_K,                                           FR_Q,           KC_G,           KC_H,           KC_F,           FR_CCED,        KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, FR_UNDS,        FR_LBRC,        FR_LPRN,        FR_EQL,         TD(DANCE_40),                                   TD(DANCE_41),   FR_PERC,        FR_RPRN,        FR_RBRC,        FR_EXLM,        CAPS_WORD,      
  ...
  [8] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AT,          ST_MACRO_13,    FR_APOS,        FR_SUP2,        ST_MACRO_14,    KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_16,    ST_MACRO_17,    FR_DQUO,        FR_UMLT,        TD(DANCE_43),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_KP_6,        KC_KP_4,        KC_KP_8,        KC_KP_0,        KC_KP_2,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_KP_3,        KC_KP_9,        KC_KP_1,        KC_KP_5,        KC_KP_7,        KC_TRANSPARENT, 
    KC_CAPSLOCK,    FR_QUES,        FR_LCBR,        FR_SECT,        TD(DANCE_42),   ST_MACRO_15,                                    ST_MACRO_18,    TD(DANCE_44),   ST_MACRO_19,    FR_RCBR,        FR_UGRV,        TD(DANCE_45),   
  ...
  [9] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_46),                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_LSHIFT,      KC_NUMLOCK,     KC_PGDOWN,      KC_DOWN,        KC_END,         TOGGLE_LAYER_COLOR,                                TO(3),          KC_KP_1,        KC_KP_2,        KC_KP_3,        TD(DANCE_47),   KC_RSHIFT,      
    ...
    KC_KP_ENTER,    KC_TRANSPARENT, DYN_REC_START1,                 DYN_REC_START2, KC_TRANSPARENT, KC_TRANSPARENT
  ),
};
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [0] = { {188,255,255}, {74,255,255}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {152,255,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {152,255,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,0,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {0,0,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {74,255,255}, {74,255,255}, {188,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {0,245,245}, {19,245,255}, {0,245,245} },

    [1] = { {188,255,255}, {168,218,204}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {152,255,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {152,255,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {0,0,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {168,218,204}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {46,215,244}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {46,215,244}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {0,0,255}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {168,218,204}, {19,245,255}, {168,218,204}, {78,218,204}, {168,218,204}, {188,255,255}, {41,255,255}, {41,255,255}, {168,218,204}, {0,245,245}, {19,245,255}, {0,245,245} },

    [2] = { {188,255,255}, {62,219,138}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {152,255,255}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {152,255,255}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {0,0,255}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {168,218,204}, {62,219,138}, {188,255,255}, {41,255,255}, {41,255,255}, {62,219,138}, {0,245,245}, {19,245,255}, {0,245,245} },

    [3] = { {188,255,255}, {131,255,255}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {1,181,132}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {1,181,132}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,0,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {19,245,255}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {46,215,244}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {0,0,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {131,255,255}, {19,245,255}, {131,255,255}, {131,255,255}, {131,255,255}, {188,255,255}, {41,255,255}, {41,255,255}, {131,255,255}, {0,245,245}, {19,245,255}, {0,245,245} },

    [4] = { {188,255,255}, {1,181,132}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {152,255,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {152,255,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {0,0,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {1,181,132}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {46,215,244}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {46,215,244}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {0,0,255}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {1,181,132}, {19,245,255}, {1,181,132}, {74,255,255}, {1,181,132}, {188,255,255}, {41,255,255}, {41,255,255}, {1,181,132}, {0,245,245}, {19,245,255}, {0,245,245} },

    [5] = { {188,255,255}, {74,255,255}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {152,255,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {152,255,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {0,0,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {46,215,244}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {1,181,132}, {74,255,255}, {0,0,0}, {46,215,244}, {41,255,255}, {74,255,255}, {0,245,245}, {19,245,255}, {0,245,245} },

    [6] = { {62,219,138}, {198,255,255}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {152,255,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {152,255,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,0,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {74,255,255}, {41,255,255}, {41,255,255}, {74,255,255}, {19,245,255}, {74,255,255}, {0,245,245}, {62,219,138}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {46,215,244}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {0,0,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {198,255,255}, {19,245,255}, {198,255,255}, {198,255,255}, {198,255,255}, {62,219,138}, {41,255,255}, {41,255,255}, {198,255,255}, {0,245,245}, {19,245,255}, {0,245,245} },

    [7] = { {188,255,255}, {62,219,138}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {1,181,132}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {1,181,132}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {0,0,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {46,215,244}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {0,0,255}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {62,219,138}, {19,245,255}, {62,219,138}, {131,255,255}, {62,219,138}, {188,255,255}, {41,255,255}, {41,255,255}, {62,219,138}, {0,245,245}, {19,245,255}, {0,245,245} },

    [8] = { {188,255,255}, {131,255,255}, {225,224,255}, {0,245,245}, {0,245,245}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {1,181,132}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {1,181,132}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {0,0,255}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {131,255,255}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {225,224,255}, {41,255,255}, {41,255,255}, {225,224,255}, {19,245,255}, {225,224,255}, {0,245,245}, {188,255,255}, {46,215,244}, {46,215,244}, {0,245,245}, {225,224,255}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {46,215,244}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {46,215,244}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {131,255,255}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {131,255,255}, {19,245,255}, {131,255,255}, {62,219,138}, {131,255,255}, {188,255,255}, {41,255,255}, {41,255,255}, {131,255,255}, {0,245,245}, {19,245,255}, {0,245,245} },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_13:
    if (record->event.pressed) {
      SEND_STRING(SS_RALT(SS_TAP(X_2)) SS_DELAY(100) SS_TAP(X_SPACE));
    }
    break;
    case ST_MACRO_14:
    if (record->event.pressed) {
...
qk_tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_8] = ACTION_TAP_DANCE_TAP_HOLD(KC_PGDOWN, LSFT(KC_PGDOWN)),
        [DANCE_10] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_COLN),
        [DANCE_22] = ACTION_TAP_DANCE_TAP_HOLD(LSFT(KC_INSERT), LCTL(KC_INSERT)),
        ...
        [DANCE_32] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, RALT(KC_5)),
        [DANCE_33] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, RALT(RSFT(KC_4))),
        [DANCE_34] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, RALT(KC_5)),
        [DANCE_35] = ACTION_TAP_DANCE_TAP_HOLD(LSFT(RALT(KC_SCOLON)), KC_GRAVE),
        [DANCE_36] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, RALT(RSFT(KC_4))),
        [DANCE_38] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_SCLN),
        [DANCE_39] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_COLN),
        [DANCE_40] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_EURO),
        [DANCE_41] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_PND),
        [DANCE_42] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_EURO),
        [DANCE_43] = ACTION_TAP_DANCE_TAP_HOLD(FR_OVRR, FR_GRV),
        [DANCE_44] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_PND),
        [DANCE_46] = ACTION_TAP_DANCE_TAP_HOLD(KC_DELETE, LALT(LCTL(KC_DELETE))),
        [DANCE_47] = ACTION_TAP_DANCE_TAP_HOLD(KC_KP_DOT, KC_KP_COMMA),
