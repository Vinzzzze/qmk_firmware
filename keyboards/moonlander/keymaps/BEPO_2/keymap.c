...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_ESCAPE,      RALT(BP_2),     TD(DANCE_0),    RALT(BP_COMM),  TD(DANCE_1),    BP_LGIL,        KC_DELETE,                                      TD(DANCE_11),   BP_RGIL,        BP_GRV,         BP_DQOT,        TD(DANCE_12),   RALT(BP_3),     BP_APOS,        
    ...
    TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TT(1),          BP_C,           TD(DANCE_9),                                                                                                    TD(DANCE_13),   BP_W,           BP_UGRV,        KC_LEFT,        KC_RIGHT,       ST_MACRO_0,     
    KC_ENTER,       KC_LCTRL,       TD(DANCE_10),                   KC_RCTRL,       KC_RALT,        KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_14),   TD(DANCE_15),   TD(DANCE_16),   TD(DANCE_17),   TD(DANCE_18),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_21),   TD(DANCE_22),   TD(DANCE_23),   TD(DANCE_24),   TD(DANCE_25),   BP_TILD,        
    ...
    TD(DANCE_19),   BP_UNDS,        BP_LBRC,        BP_LPRN,        BP_EQL,         TD(DANCE_20),                                   TD(DANCE_26),   BP_PERC,        BP_RPRN,        BP_RBRC,        BP_EXLM,        TD(DANCE_27),   
  ...
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, ST_MACRO_1,     TD(DANCE_28),   ST_MACRO_2,     KC_MINUS,       RALT(KC_LBRACKET),KC_TRANSPARENT,                                 KC_TRANSPARENT, RALT(KC_RBRACKET),ST_MACRO_6,     ST_MACRO_7,     TD(DANCE_32),   ST_MACRO_8,     KC_QUOTE,       
    ...
    KC_TRANSPARENT, KC_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_29),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           KC_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, ST_MACRO_5,     KC_Y,           KC_X,           TD(DANCE_30),   KC_K,                                           KC_Q,           KC_G,           KC_H,           KC_F,           ST_MACRO_9,     KC_TRANSPARENT, 
    TD(DANCE_31),   KC_TRANSPARENT, KC_TRANSPARENT, TT(3),          KC_C,           KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_W,           ST_MACRO_10,    KC_TRANSPARENT, KC_TRANSPARENT, RALT(KC_M),     
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_33),   TD(DANCE_34),   TD(DANCE_35),   TD(DANCE_36),   TD(DANCE_37),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_40),   TD(DANCE_41),   TD(DANCE_42),   TD(DANCE_43),   TD(DANCE_44),   ST_MACRO_12,    
    ...
    TD(DANCE_38),   KC_UNDS,        KC_LBRACKET,    KC_LPRN,        KC_EQUAL,       TD(DANCE_39),                                   TD(DANCE_45),   KC_PERC,        KC_RPRN,        KC_RBRACKET,    KC_EXLM,        TD(DANCE_46),   
  ...
  [4] = LAYOUT_moonlander(
    KC_TRANSPARENT, ST_MACRO_13,    TD(DANCE_47),   FR_APOS,        TD(DANCE_48),   ST_MACRO_14,    KC_TRANSPARENT,                                 KC_TRANSPARENT, ST_MACRO_15,    ST_MACRO_16,    FR_DQUO,        TD(DANCE_52),   ST_MACRO_17,    FR_GRV,         
    KC_TRANSPARENT, KC_B,           FR_EACU,        KC_P,           KC_O,           FR_EGRV,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_V,           KC_D,           KC_L,           KC_J,           FR_Z,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_A,           KC_U,           KC_I,           KC_E,           TD(DANCE_49),   KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_T,           KC_S,           KC_R,           KC_N,           FR_M,           KC_TRANSPARENT, 
    KC_TRANSPARENT, FR_AGRV,        KC_Y,           KC_X,           TD(DANCE_50),   KC_K,                                           FR_Q,           KC_G,           KC_H,           KC_F,           FR_CCED,        KC_TRANSPARENT, 
    TD(DANCE_51),   KC_TRANSPARENT, KC_TRANSPARENT, TT(5),          KC_C,           KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, FR_W,           FR_UGRV,        KC_TRANSPARENT, KC_TRANSPARENT, FR_MU,          
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_moonlander(
    KC_TRANSPARENT, TD(DANCE_53),   TD(DANCE_54),   TD(DANCE_55),   TD(DANCE_56),   TD(DANCE_57),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_60),   TD(DANCE_61),   TD(DANCE_62),   TD(DANCE_63),   TD(DANCE_64),   FR_TILD,        
    ...
    TD(DANCE_58),   FR_UNDS,        FR_LBRC,        FR_LPRN,        FR_EQL,         TD(DANCE_59),                                   TD(DANCE_65),   FR_PERC,        FR_RPRN,        FR_RBRC,        FR_EXLM,        TD(DANCE_66),   
  ...
  [6] = LAYOUT_moonlander(
    TD(DANCE_67),   TD(DANCE_68),   TD(DANCE_69),   TD(DANCE_70),   TD(DANCE_71),   TD(DANCE_72),   KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_73),   TD(DANCE_74),   TD(DANCE_75),   TD(DANCE_76),   TD(DANCE_77),   TD(DANCE_78),   
    ...
    KC_LSHIFT,      KC_NUMLOCK,     KC_PGDOWN,      KC_DOWN,        KC_END,         TOGGLE_LAYER_COLOR,                                TO(2),          KC_KP_1,        KC_KP_2,        KC_KP_3,        TD(DANCE_79),   KC_RSHIFT,      
    KC_TRANSPARENT, RESET,          DYN_MACRO_PLAY1,DYN_MACRO_PLAY2,DYN_REC_STOP,   KC_MS_BTN1,                                                                                                     KC_MS_BTN2,     KC_MS_BTN3,     KC_KP_0,        KC_MS_LEFT,     KC_MS_RIGHT,    TD(DANCE_80),   
...
qk_tap_dance_action_t tap_dance_actions[] = {
        ...
        [DANCE_12] = ACTION_TAP_DANCE_TAP_HOLD(BP_DCRC, BP_DTRM),
        [DANCE_20] = ACTION_TAP_DANCE_TAP_HOLD(BP_DOT, BP_EURO),
        [DANCE_26] = ACTION_TAP_DANCE_TAP_HOLD(BP_COMM, RALT(RSFT(BP_L))),
        [DANCE_29] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, KC_SCOLON),
        [DANCE_30] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, KC_COLN),
        [DANCE_32] = ACTION_TAP_DANCE_TAP_HOLD(KC_CIRC, KC_DQUO),
        [DANCE_39] = ACTION_TAP_DANCE_TAP_HOLD(KC_DOT, RALT(KC_5)),
        [DANCE_45] = ACTION_TAP_DANCE_TAP_HOLD(KC_COMMA, RALT(RSFT(KC_4))),
        [DANCE_47] = ACTION_TAP_DANCE_TAP_HOLD(FR_AT, FR_OVRR),
        [DANCE_48] = ACTION_TAP_DANCE_TAP_HOLD(FR_MINS, FR_SUP2),
        [DANCE_49] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_SCLN),
        [DANCE_50] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_COLN),
        [DANCE_52] = ACTION_TAP_DANCE_TAP_HOLD(FR_CCIRC, FR_UMLT),
        [DANCE_59] = ACTION_TAP_DANCE_TAP_HOLD(FR_DOT, FR_EURO),
        [DANCE_65] = ACTION_TAP_DANCE_TAP_HOLD(FR_COMM, FR_PND),
        [DANCE_67] = ACTION_TAP_DANCE_TAP_HOLD(KC_MEDIA_PREV_TRACK, KC_MEDIA_REWIND),
